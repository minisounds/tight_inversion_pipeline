...
class FluxPipelineInversionIPA(
    DiffusionPipeline,
    FluxLoraLoaderMixin,
    FromSingleFileMixin,
    ...
    def prepare_ip_adapter_image_embeds(
        ...
        if ip_adapter_image_embeds is None:
            ...
            for single_ip_adapter_image, image_proj_layer in zip(
                ...
                single_image_embeds = self.encode_image_ip_adapter(single_ip_adapter_image, device, 1)
    ...
    def invert(
        ...
        Y_t = image_latents * nudge_factor
        y_1 = randn_tensor(Y_t.shape, generator=generator, device=Y_t.device, dtype=Y_t.dtype)
        ...
        with self.progress_bar(total=N - 1) as progress_bar:
            for i in range(N - 1):
                ...
                if do_true_cfg:
                    ...
                    u_t_i = neg_u_t_i + true_cfg_scale * (u_t_i - neg_u_t_i)
